  ...
  <div class="container">
    ...
    <div class="cat_result">
      ...
      if (!empty($_POST)) {
        ...
        $year = $_POST['year'];
        $color = $_POST['color'];
        echo ('<h2>Nombre del gato </h2><p>' . $name).'</p>';
        echo ('<h2>Edad del gato </h2><p>' . $year).' años</p>';
        echo ('<h2>Color del gato </h2><p>' . $color).'</p>';
      } else {
      ?>
    </div>
    <form action="exercise_2.php" method="post" class="type_cat">
